...
func main() {
	...
	for update := range updates {
		if update.Message != nil { // If we got a message
			...
			case "Платья":
				informativeAnswer(bot, update, "Вот изделия из категории \"Платья\":", Path+"/dresses")
			case "Костюмы":
				informativeAnswer(bot, update, "Вот изделия из категории \"Костюмы\":", Path+"/suits")
			case "Халаты":
				informativeAnswer(bot, update, "Вот изделия из категории \"Халаты\":", Path+"/bathrobe")
			case "Кимоно":
				informativeAnswer(bot, update, "Вот изделия из категории \"Кимоно\":", Path+"/kimono")
			case "Аксессуары":
				informativeAnswer(bot, update, "Вот изделия из категории \"Аксессуары\":", Path+"/accessories")
			case "Новинки":
				informativeAnswer(bot, update, "Вот изделия из категории \"Новинки\":", Path+"/news")
			default:
				simpleAnswerTextWithKeyBoard(bot, update, fmt.Sprintf("В каталоге нет такой категории: %v", update.Message.Text))
