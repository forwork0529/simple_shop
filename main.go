...
func main() {
	...
	for update := range updates {
		if update.Message != nil { // If we got a message
			...
			case "Платья" : informativeAnswer(bot, update, "Вот изделия из категории \"Платья\":", "./packages/photos/dresses" )
			case "Костюмы" : informativeAnswer(bot, update, "Вот изделия из категории \"Костюмы\":","./packages/photos/suits")
			case "Халаты" : informativeAnswer(bot, update, "Вот изделия из категории \"Халаты\":", "./packages/photos/bathrobe")
			case "Кимоно" : informativeAnswer(bot, update, "Вот изделия из категории \"Кимоно\":","./packages/photos/kimono")
			case "Аксесуары" : informativeAnswer(bot, update, "Вот изделия из категории \"Аксессуары\":", "./packages/photos/accessories")
			case "Новинки" : informativeAnswer(bot, update, "Вот изделия из категории \"Новинки\":", "./packages/photos/news")
